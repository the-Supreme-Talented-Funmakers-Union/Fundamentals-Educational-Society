...
public class Card : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Input.GetMouseButtonUp(0))
        {
            if (isDragging)
            {
                ...
                {
                    transform.SetParent(GameObject.Find("P1Hand").transform);
    ...
    public static void RevealCard(GameObject cardObject)
    {
        ...
        {
            cardObject.GetComponent<SpriteRenderer>().sprite = Resources.Load<Sprite>("Sprites/Math/Pokers" + "/" + cardObject.GetComponent<Card>().GetCardType + cardObject.GetComponent<Card>().GetCardValue.ToString());
        }
        else if (cardObject.GetComponent<Card>().GetCardValue <= 14)
        {
            cardObject.GetComponent<SpriteRenderer>().sprite = Resources.Load<Sprite>("Sprites/Math/Pokers/JokerBlack");
        }
